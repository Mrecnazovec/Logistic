const messages: Record<string, string> = {
	...
	'register.fields.passwordMin': 'Пароль должен быть не менее 8 символов',
	'register.fields.passwordMismatch': 'Пароли не совпадают',
	'register.fields.passwordShow': 'Показать пароль',
	'register.fields.passwordHide': 'Скрыть пароль',
