const messages: Record<string, string> = {
	...
	'order.status.progress.remainingMinutes': 'Осталось ~{minutes} мин',
	'order.status.progress.arrivingSoon': 'Скоро прибудет (<30 мин)',
	'order.status.progress.via': 'Через',
	'order.status.progress.notStarted': 'Водитель ещё не начал путь',
	'order.status.progress.pendingLoading': 'Водитель ещё не погрузился',
	'order.status.progress.noDriver': 'Водителя нет в перевозке',
	'order.status.progress.completedDelivery': 'Доставка завершена',
