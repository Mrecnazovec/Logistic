const messages: Record<string, string> = {
	...
	'order.status.progress.remainingMinutes': '~{minutes} daqiqa qoldi',
	'order.status.progress.arrivingSoon': 'Tez orada yetib keladi (<30 min)',
	'order.status.progress.via': "Orqali",
	'order.status.progress.notStarted': "Haydovchi hali yo'lga chiqmagan",
	'order.status.progress.pendingLoading': "Haydovchi hali yuklanmagan",
	'order.status.progress.noDriver': "Bu tashuvga haydovchi biriktirilmagan",
	'order.status.progress.completedDelivery': 'Yetkazib berish yakunlandi',
