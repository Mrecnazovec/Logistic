const messages: Record<string, string> = {
	...
	'components.inviteDriver.driverPaymentRequired': 'Выберите способ оплаты.',
	'components.inviteDriver.driverPriceTooHigh': 'Цена водителя не может превышать стоимость заказа.',
	...
	'components.cargoActions.delete': 'Удалить',
	'components.cargoActions.deleteDetail': 'Удаление объявления',
	'components.cargoActions.deleteConfirmTitle': 'Вы уверены?',
	'components.cargoActions.deleteConfirmDescription': 'это действие нельзя отменить',
	'components.cargoActions.deleteConfirmCancel': 'Отмена',
	'components.cargoActions.deleteConfirmConfirm': 'Подтвердить',
