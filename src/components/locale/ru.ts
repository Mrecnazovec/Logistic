const messages: Record<string, string> = {
	...
	'dashboard.stats.card1.label': 'Новые заявки',
	'dashboard.stats.card2.label': 'Активные перевозки',
	'dashboard.stats.card3.label': 'Завершенные перевозки',
	'dashboard.cta.text': 'Видеоинструкция будет добавлена в следующих обновлениях!',
