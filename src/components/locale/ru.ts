const messages: Record<string, string> = {
	...
	'components.dashboard.headerNav.rating.logistics': 'Экспедиторы',
	'components.dashboard.headerNav.rating.customers': 'Грузовладельцы',
	'components.dashboard.headerNav.rating.carriers': 'Перевозчики',
