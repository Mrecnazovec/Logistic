const messages: Record<string, string> = {
	...
	'components.dashboard.nav.home': 'Homepage',
	...
	'components.dashboard.headerNav.back.toCargo': 'Back to cargo',
	...
	'components.inviteDriver.trigger': 'Invite participant',
	...
	'components.inviteDriver.driverPriceLabel': 'Driver price (max: {maxPrice})',
	'components.inviteDriver.driverPricePlaceholder': 'Enter driver price',
	'components.inviteDriver.driverPriceRequired': 'Enter driver price.',
	'components.inviteDriver.driverCurrencyRequired': 'Select driver currency.',
	'components.inviteDriver.driverPaymentRequired': 'Select payment method.',
	'components.inviteDriver.driverPriceTooHigh': 'Driver price cannot exceed the order total.',
	'components.inviteDriver.byId.title': 'Invite participant by ID',
	'components.inviteDriver.byId.placeholder': 'Enter participant ID',
	...
	'components.inviteDriver.byLink.description': 'Generate a link and send it to the participant so they can accept the invitation.',
	...
	'components.cargoActions.delete': 'Delete',
	'components.cargoActions.deleteDetail': 'Announcement deletion',
	'components.cargoActions.deleteConfirmTitle': 'Are you sure?',
	'components.cargoActions.deleteConfirmDescription': 'This action cannot be undone.',
	'components.cargoActions.deleteConfirmCancel': 'Cancel',
	'components.cargoActions.deleteConfirmConfirm': 'Confirm',
	...
	'dashboard.hero.eyebrow': 'Our solutions',
	'dashboard.hero.title': 'A unified platform for searching and managing transportation',
	'dashboard.stats.caption': 'last 30 days',
	'dashboard.stats.card1.label': 'Total users',
	'dashboard.stats.card2.label': 'Online',
	'dashboard.stats.card3.label': 'Number of applications',
	'dashboard.cta.text': 'Coming soon!',
	'dashboard.roles.eyebrow': 'Our sections',
	'dashboard.roles.customer.title': 'Cargo owner',
	'dashboard.roles.customer.cards.publications.title': 'Publications',
	'dashboard.roles.customer.cards.publications.description': 'Create a request and start searching for a carrier by the needed criteria',
	'dashboard.roles.customer.cards.search.title': 'Search transports',
	'dashboard.roles.customer.cards.search.description': 'Start searching for transports and compare market prices',
	'dashboard.roles.customer.cards.open.title': 'Open requests',
	'dashboard.roles.customer.cards.open.description': 'Negotiate and monitor requests that are still waiting for carriers',
	'dashboard.roles.customer.cards.active.title': 'Active transports',
	'dashboard.roles.customer.cards.active.description': 'Track the current transport status in real time until completion',
	'dashboard.roles.customer.cards.check.title': 'Check company',
	'dashboard.roles.customer.cards.check.description': 'Review partners’ work history and feedback',
	'dashboard.roles.customer.cards.history.title': 'History',
	'dashboard.roles.customer.cards.history.description': 'Open your history and review old documents',
	'dashboard.roles.logistic.title': 'Logistics',
	'dashboard.roles.logistic.cards.publications.title': 'Publications',
	'dashboard.roles.logistic.cards.publications.description': 'Create a request and start searching for a carrier by the needed criteria',
	'dashboard.roles.logistic.cards.search.title': 'Search transports',
	'dashboard.roles.logistic.cards.search.description': 'Start searching for transports and compare market prices',
	'dashboard.roles.logistic.cards.trade.title': 'Trading',
	'dashboard.roles.logistic.cards.trade.description': 'Participate in trading as both a customer and a transport service provider',
	'dashboard.roles.logistic.cards.active.title': 'Active transports',
	'dashboard.roles.logistic.cards.active.description': 'Track the current transport status in real time until completion',
	'dashboard.roles.logistic.cards.check.title': 'Check company',
	'dashboard.roles.logistic.cards.check.description': 'Review partners’ work history and feedback',
	'dashboard.roles.logistic.cards.history.title': 'History',
	'dashboard.roles.logistic.cards.history.description': 'Open your history and review old documents',
	'dashboard.roles.carrier.title': 'Carrier',
	'dashboard.roles.carrier.cards.search.title': 'Search',
	'dashboard.roles.carrier.cards.search.description': 'Find the right cargo and participate in transport bidding',
	'dashboard.roles.carrier.cards.myOffers.title': 'My offers',
	'dashboard.roles.carrier.cards.myOffers.description': 'Finish trading and start the transport',
	'dashboard.roles.carrier.cards.personal.title': 'Personal offers',
	'dashboard.roles.carrier.cards.personal.description': 'Respond to personal service offers',
	'dashboard.roles.carrier.cards.active.title': 'Active transports',
	'dashboard.roles.carrier.cards.active.description': 'Update transport status and upload documents',
	'dashboard.roles.carrier.cards.check.title': 'Check company',
	'dashboard.roles.carrier.cards.check.description': 'Review partners’ work history and feedback',
	'dashboard.roles.carrier.cards.history.title': 'History',
	'dashboard.roles.carrier.cards.history.description': 'Open your history and review old documents',
	'dashboard.contact.eyebrow': 'Contact us',
	'dashboard.contact.title': 'We would love to hear from you',
	'dashboard.contact.subtitle': 'Our friendly team is always ready to chat.',
	'dashboard.contact.sales.title': 'Chat with sales',
	'dashboard.contact.sales.description': 'Talk with our friendly team.',
	'dashboard.contact.support.title': 'Support chat',
	'dashboard.contact.support.description': 'We are here to help.',
	'dashboard.contact.phone.title': 'Call us',
	'dashboard.contact.phone.description': 'Mon–Fri from 8am to 5pm.',
}
